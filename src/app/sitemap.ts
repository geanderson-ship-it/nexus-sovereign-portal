...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://www.nexusholdinggroup.com.br';
  ...
  const staticRoutes = [
    ...
    '/nexus-rotas/atracoes',
    '/nexus-rotas/embaixadora',
    '/nexus-rotas/gastronomia',
    '/nexus-rotas/hoteis',
    '/propostas/cidades-do-futuro',
    '/proposito/ia-de-companhia',
    '/proposito/regras-adocao',
    '/djeny-design',
    '/pactum-legal',
    '/pactum-legal/marcas',
    '/pactum-legal/patentes',
    '/pactum-legal/atualizacoes',
    '/pactum-link',
    '/nexus-empresas/rh',
