...
export default function PrecificacaoPage() {
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'empresas' | 'premium' | 'segmentos' | 'cursos' | 'consulta'>('all');
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-12 border-b border-emerald-900/50 pb-8">
          <div className="flex items-center gap-4">
            <Link href="/gabinete-vendas">
              <div className="w-16 h-16 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center hover:border-emerald-500 hover:scale-105 transition-all cursor-pointer">
