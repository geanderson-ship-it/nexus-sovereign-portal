      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10 border-b border-emerald-900/30 pb-8">
          <div className="flex items-center gap-4">
            <Link href="/gabinete-vendas" className="w-12 h-12 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-emerald-950/30 hover:border-emerald-500/50 transition-all group cursor-pointer shadow-[0_0_15px_rgba(16,185,129,0.05)]">
