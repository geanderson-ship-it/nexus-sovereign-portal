  ...
  return (
    <div className="min-h-screen relative text-slate-200 py-12 px-4 bg-slate-950 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <Link href="/gabinete-vendas" className="inline-flex items-center text-sm text-slate-400 hover:text-white transition-colors mb-8 bg-slate-900/50 backdrop-blur-md px-3 py-1.5 rounded-lg border border-slate-800/80 hover:border-slate-700/80">
