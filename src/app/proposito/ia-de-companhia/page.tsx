          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-start mb-20 relative z-10">
            ...
            <div className="bg-[#0b101a] border border-slate-800 rounded-3xl p-6 md:p-8 hover:border-rose-500/30 transition-all group">
               <div className="relative aspect-square w-full rounded-2xl overflow-hidden mb-8 border border-slate-700 group-hover:border-rose-500/50 transition-colors shadow-2xl">
                <CustomVideoPlayer
                  src={getVideoUrl("https://amplify-nextn-geand-sandb-nexusmediabucketfc7a44b7-nwolydnxg4ep.s3.amazonaws.com/public/Social/Aurora_social.mp4", "aurora_social.mp4")}
                  containerClassName="absolute inset-0 w-full h-full"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  poster="/avatars/aurora.png"
                  playButtonClassName="bg-rose-600/80 hover:bg-rose-600 shadow-[0_0_20px_rgba(225,29,72,0.5)] hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b101a] via-transparent to-transparent opacity-80 pointer-events-none z-10" />
            ...
            <div className="bg-[#0b101a] border border-slate-800 rounded-3xl p-6 md:p-8 hover:border-blue-500/30 transition-all group">
              <div className="relative aspect-square w-full rounded-2xl overflow-hidden mb-8 border border-slate-700 group-hover:border-blue-500/50 transition-colors shadow-2xl">
                <CustomVideoPlayer
                  src={getVideoUrl("https://amplify-nextn-geand-sandb-nexusmediabucketfc7a44b7-nwolydnxg4ep.s3.amazonaws.com/public/Social/Ravi_social.mp4", "ravi_social.mp4")}
                  containerClassName="absolute inset-0 w-full h-full"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  poster="/avatars/ravi.png"
                  playButtonClassName="bg-blue-600/80 hover:bg-blue-600 shadow-[0_0_20px_rgba(37,99,235,0.5)] hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b101a] via-transparent to-transparent opacity-80 pointer-events-none z-10" />
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end pointer-events-none z-20">
                  <div>
