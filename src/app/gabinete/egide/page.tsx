...
export default function EgidePage() {
  ...
  const [tacticalStatus, setTacticalStatus] = useState<'alert' | 'dispatched' | 'ignored'>('alert');
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10 border-b border-blue-900/30 pb-8">
          <div className="flex items-center gap-4">
            <Link href="/gabinete" className="w-12 h-12 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-blue-950/30 hover:border-blue-500/50 transition-all group cursor-pointer shadow-[0_0_15px_rgba(59,130,246,0.05)]">
