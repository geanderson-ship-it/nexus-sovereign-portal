    ...
    <div className="flex flex-col min-h-screen items-center text-white py-12 px-4 bg-[#020617] relative">
      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        {isAdmin && (
          ...
          >
            <Card className="bg-pink-500/10 border-pink-500/40 backdrop-blur-3xl rounded-[40px] p-10 text-center border-dashed border-2 shadow-[0_0_50px_rgba(219,39,119,0.2)]">
              <div className="bg-pink-500/20 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                <Sparkles className="h-10 w-10 text-pink-400" />
              </div>
              <h3 className="text-3xl font-black italic text-white uppercase tracking-tighter mb-4">Acesso Business Liberado</h3>
              <p className="text-pink-400 font-bold uppercase tracking-[0.3em] text-xs mb-8 opacity-80">Credencial Administrador Nexus Detectada</p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Button asChild className="bg-pink-600 text-white hover:bg-pink-500 h-16 px-10 rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl">
                  <Link href="/intelligence/djeny-design/trial">Entrar no Estúdio Djeny</Link>
                </Button>
              </div>
            </Card>
          </motion.div>
        ...
        <div className={cn("grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20", isAdmin && "opacity-40 grayscale pointer-events-none")}>
          {/* PERSONAL TIER */}
