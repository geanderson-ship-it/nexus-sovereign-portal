...
export function SiteFooter() {
  ...
  const showWhatsappCard = pathname.includes('/contact') || pathname.includes('/suporte');
  const showExecutiveCards = !pathname.includes('/contact') && !pathname.includes('/suporte');
        ...
        <div className="container max-w-2xl mx-auto mb-12">
          <div className="bg-gradient-to-br from-[#080b10] via-[#021136] to-[#080b10] backdrop-blur-md border border-blue-500/40 rounded-3xl p-8 md:p-10 flex flex-col items-center text-center shadow-[0_0_40px_rgba(37,99,235,0.2)]">
            ...
            <p className="text-blue-200/80 text-sm leading-relaxed mb-8 max-w-lg font-medium">
              Fale agora com a diretoria e descubra como implantar nossas soluções de Inteligência Artificial exclusivas no seu negócio. Atendimento imediato via WhatsApp.
            </p>
            <button
            ...
            <span className="relative z-10 text-yellow-400">Falar com a Diretoria</span>
          </button>
        </div>
      </div>
      )}
        ...
        <div className="container max-w-6xl mx-auto px-4 mb-12">
          <div className="bg-gradient-to-br from-[#080b10]/95 via-[#021136]/90 to-[#080b10]/95 backdrop-blur-md border border-blue-500/40 rounded-3xl p-8 md:p-10 shadow-[0_0_50px_rgba(37,99,235,0.25)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Ivoni Card */}
              <div className="border-l-2 border-blue-400/30 pl-3 flex items-start gap-4 bg-zinc-950/40 p-4 rounded-xl border border-blue-400/10">
